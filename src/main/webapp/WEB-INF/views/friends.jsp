					...
					<c:if test="${friend.friendUserName!=userName}" >
					 ...
					 <li class="com fl">                                                                                                                                                                                        
			          <a href="profile??user=${friend.friendUserName}" class="url" rel="friend">                                                                                                                       
						...
						<div id="nav">
							<a href="profile?user=${friend.friendUserName}" ><img style="padding-top: 0px; border: none;" src="resources/images/user.png"/>&nbsp;<font color="blue" size="6" face="verdana">${friend.friendUserName}</font></a> </div>
							<div id="nav">
							<a href="reviews?user=${friend.friendUserName}" >&nbsp;<font color="blue" size="6" face="verdana">See Reviews</font></a> </div>
					</c:if>
				</c:forEach>                                                                                                                                                                                                               
		      <%-- {% for item in items %}
		        <li class="vcard">                                                                                                                                                                                        
