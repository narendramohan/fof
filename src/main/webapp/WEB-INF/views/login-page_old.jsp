...
body
{
background-image:url('../resources/images/blink.jpg');
...
<form:form name="loginForm" commandName="loginForm" action="/fof/login-user"
	method="POST">
	<form:errors path="*" cssClass="errorblock" element="div"/>
	<h2 align="left"><font color="#EEDD82">Job Search</font></h2>
	<br clear="all" />
	<br clear="all" />
	<%
...
%>
	...
	<tr>
			<td ><div><img src="../resources/images/findjob.jpg"> </div></td>
	<td>
	<table align="right" border="1" style="border-color: teal; border-width: 1pt;border-spacing: 0pt">
		...
		<tr style="background: teal;">
		<td>&nbsp;</td>
			<td align="left"><input type="submit" value="Login" />&nbsp;|&nbsp;<a href="../register"><font color="white">Signup</font></a></td>
		</tr>
