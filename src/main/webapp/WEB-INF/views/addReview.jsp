...
<div class="main">
  <div class="main_resize">
    <div class="header">
      ...
      <div class="hbg"><img src="resources/images/newreview.jpg" width="923" height="291" alt="" /></div>
    </div>
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Congrates, Please create your review!</span></h2>
            <div class="clr"></div>
            <p>You can create reviews for the selected products here. Be free and honest about your review.</p>
          </div>
          <div class="article">
            <h2><span>New</span> review</h2>
            <div class="clr"></div>
            <form:form commandName="review" action="saveReview" method="post" id="sendemail">
              <ol>
                <li>
                  <label for="name">Product Name (required)</label>
                  <form:input path="productName" id="productName" name="productName" class="text" />
                  <input type="hidden" id="productId" name="productId" class="text" />
                </li>
                <li>
                  <label for="email">Title (required)</label>
                  <form:input path="title" id="email" name="email" class="text" />
                </li>

                <li>
                  <label for="message">Description</label>
                  <form:textarea path="description" id="message" name="message" rows="8" cols="50"></form:textarea>
                </li>

                <li>
                  <label for="website">Rating value for Money</label>
                  <div id="vfm" data-id="1"></div>
                  <form:input type="hidden" path="valueForMoneyRating" id="valueForMoneyRating" name="valueForMoneyRating" class="texter" />
                </li>
                <li>
                  <label for="website">Rating for services</label>
                  <div id="ras" data-id="1"></div>
                  <form:input type="hidden" path="sevicesRating" id="sevicesRating" name="sevicesRating" class="texter" />
                </li>
                <li>
                  <label for="website">Your rating for Product</label>
                  <div id="yrp" data-id="1"></div>
                  <form:input type="hidden" path="reviewsByperson" id="reviewsByperson" name="reviewsByperson" class="texter" />
                </li>
                <li>
                  <input type="image" name="imageField" id="imageField" src="resources/images/submit.gif" class="send" onclick="doSomething()"/>
                  <div class="clr"></div>
                </li>                
              </ol>
            </form:form>
